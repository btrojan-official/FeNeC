...
def main():
    ...
    for _, row in df.iterrows():
        ...
        accs_1 = run_evaluation(args.dataset, config, args.num_of_tasks, args.name1, args.sufix)
        accs_2 = run_evaluation(args.dataset, config, args.num_of_tasks, args.name2, args.sufix)
        accs_3 = run_evaluation(args.dataset, config, args.num_of_tasks, args.name3, args.sufix)
        ...
        avg_of_avg_acc = (sum(accs_1) / len(accs_1) + sum(accs_2) / len(accs_2) + sum(accs_3) / len(accs_3)) / 3.0
