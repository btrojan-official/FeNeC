...
def get_config(trial):
    return {
        ...
        "weight": "distance",
        "use_tukey": True,
        "tukey_lambda": trial.suggest_float("tukey_lambda", 0.2, 1),
        "num_of_shrinkages": 2,
        "shrinkage_alpha_0": trial.suggest_float("shrinkage_alpha_0", 0.5, 20),
        "shrinkage_alpha_1": trial.suggest_float("shrinkage_alpha_1", 0.5, 20),
        "norm_in_mahalanobis": True,
        "knn_k": trial.suggest_int("knn_k", 1, 40),
        "use_kmeans": True,
        "kmeans_k": trial.suggest_int("kmeans_k", 2, 75),
        "sklearn_seed": 42,
        "use_logits": False,
