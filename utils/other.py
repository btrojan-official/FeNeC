...
class GradKNNDataloader:
    def __init__(self, num_tasks=6, dataset_name="resnet", load_covariances=False, load_prototypes=False):
        """
        ...
        for task_num in range(self.num_tasks):
            current_file = f"./data/{self.dataset_name}/task_{task_num}.hdf5"
